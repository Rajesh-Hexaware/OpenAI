...
export class SidebarService {
  ...
  //         },
  //         {
  //           menuValue: 'Product Differentiation',
  //           route: routes.addProduct,
  //           hasSubRoute: false,
  //           showSubRoute: false,
  //           icon: 'plus-square',
  ...
  //         },
  //         {
  //           menuValue: 'Marketing and Promotion',
  //           route: routes.importProduct,
  //           hasSubRoute: false,
  //           showSubRoute: false,
  //           icon: 'minimize-2',
  ...
  //     menu: [
  //       {
  //         menuValue: 'Fulfillment and Shipping',
  //         route: routes.salesList,
  //         hasSubRoute: false,
  //         showSubRoute: false,
  //         icon: 'shopping-cart',
  ...
  //       },
  //       {
  //         menuValue: 'Inventory Management',
  ...
  //       },
  //       {
  //         menuValue: 'Product Planning & Listing Help & Optimization',
  //         route: routes.importPurchase,
  //         hasSubRoute: false,
  //         showSubRoute: false,
  //         icon: 'minimize-2',
  ...
  private sidebarDataone: Array<any> = [
    ...
    {
      tittle: 'Social Channel Marketing',
      showAsTab: true,
      separateRoute: false,
      menu: [
        {
          menuValue: 'Social Channel Marketing',
          route: routes.expense,
          hasSubRoute: true,
          showSubRoute: false,
          icon: 'file-text',
